...
namespace AdditionBonusTask.Controllers
{
    public class MessagesController : Controller
    {
        ...
        {
            var authDbContext = _context.Messages.Include(m => m.User);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MessageText,DateOfMessage,UserSenderId,UserReceiverId")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
